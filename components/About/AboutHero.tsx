        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-slate-600 mb-8 leading-relaxed">
              With a legacy of excellence and innovation, we &apos;ve been partnering
              with businesses globally to transform their operations and unlock
              unprecedented growth opportunities.
            </p>

            <div className="flex gap-4">
              <button className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-b from-orange-500 to-orange-600 text-white font-semibold rounded-lg hover:shadow-lg hover:shadow-orange-200 transition-all duration-300">
                Learn More
                <ArrowRight size={20} weight="bold" />
              </button>
              <button className="inline-flex items-center gap-2 px-6 py-3 border-2 border-orange-200 text-orange-700 font-semibold rounded-lg hover:bg-orange-50 transition-all duration-300">
                Get in Touch
              </button>
            </div>
          </motion.div>
